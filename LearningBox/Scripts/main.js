...
(function () {
  ...
  try {
    ...
    var data4 = [102, 70, 80, 100, 56, 53, 80, 75, 65, 90]
      ...
      ctx = document.getElementById("recent-rep2-chart");
      if (ctx) {
      ctx.height = 230;
          myChart = new Chart(ctx, {
              type: 'line',
  ...
  try {
    ...
    var data6 = [102, 70, 80, 100, 56, 53, 80, 90];
      ...
      ctx = document.getElementById("recent-rep3-chart");
      if (ctx) {
      ctx.height = 230;
          myChart = new Chart(ctx, {
              type: 'line',
  ...
  try {
    //WidgetChart 5
      ctx = document.getElementById("widgetChart5");
      if (ctx) {
      ctx.height = 220;
          myChart = new Chart(ctx, {
              type: 'bar',
  ...
  try {
    ...
    // Percent Chart 2
      ctx = document.getElementById("percent-chart2");
      if (ctx) {
      ctx.height = 209;
          myChart = new Chart(ctx, {
              type: 'doughnut',
  ...
  try {
    ...
    //Team chart
      ctx = document.getElementById("team-chart");
      if (ctx) {
      ctx.height = 150;
          myChart = new Chart(ctx, {
              type: 'line',
  ...
  try {
    ...
    //doughut chart
      ctx = document.getElementById("doughutChart");
      if (ctx) {
      ctx.height = 150;
          myChart = new Chart(ctx, {
              type: 'doughnut',
  ...
  try {
    ...
    // single bar chart
      ctx = document.getElementById("singelBarChart");
      if (ctx) {
      ctx.height = 150;
          myChart = new Chart(ctx, {
              type: 'bar',
